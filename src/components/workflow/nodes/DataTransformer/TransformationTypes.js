// src/components/workflow/nodes/DataTransformer/TransformationTypes.js
// Definiciones de transformaciones basadas en Inspire Designer
...
export const TRANSFORMATION_CATEGORIES = {
  ...
  // Función para obtener transformaciones por tipo de dato
  export const getTransformationsForDataType = (dataType) => {
    switch (dataType) {
      case 'string':
        return STRING_TRANSFORMATIONS;
      case 'number':
        return NUMBER_TRANSFORMATIONS;
      case 'date':
        return DATE_TRANSFORMATIONS;
      case 'boolean':
        return BOOLEAN_TRANSFORMATIONS;
      case 'array':
        return ARRAY_TRANSFORMATIONS;
      case 'email':
        return { ...STRING_TRANSFORMATIONS, ...EMAIL_TRANSFORMATIONS };
      case 'url':
        return { ...STRING_TRANSFORMATIONS, ...URL_TRANSFORMATIONS };
      case 'object':
        return {
          none: { 
            label: 'Sin transformación', 
